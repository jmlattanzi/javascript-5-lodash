...
const myEmployeesAddresses = _.map(myEmployees, (emp) => emp.address) // use map to get addresses here.

// Now we want to use map to get an array of ages of the employees.

const myEmployeesAges = _.map(myEmployees, (emp) => emp.age) // use map to get ages here.
...
let fastFibonnaci = _.memoize((n) =>
    n < 2 ? n : fastFibonnaci(n - 1) + fastFibonnaci(n - 2)
